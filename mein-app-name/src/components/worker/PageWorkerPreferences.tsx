      ...
      <div className="col-md-5 border-right">
        <div className="p-3 py-5">
          ...
          <div className="button-group">
            ...
            <button className="button"type="button" onClick={handleUpdate}>Save Preferences</button>
            <LinkContainer to = {"/"}>
            <button className="button" type="button" onClick={() => {handleDelete(); }}>Zurücksetzen</button>
            </LinkContainer>
